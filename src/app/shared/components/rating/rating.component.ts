...
export class RatingComponent implements OnInit {
  ...
  private getRatingData(data: IProduct) {
    let product = data.reviews as unknown as Array<{ review: number, comment: string }>
    ...
    // promedio de los reviews dados, curiosamente estos dan todos 3, muy curiosamente
  }
